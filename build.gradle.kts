...
dependencies {
	...
	// Ktor client
	transitiveInclude( implementation( "io.ktor:ktor-client-core:2.3.10" )!! )
	transitiveInclude( implementation( "io.ktor:ktor-client-cio:2.3.10" )!! )
	...
	transitiveInclude( implementation( "io.ktor:ktor-client-serialization:2.3.10" )!! )
	...
	transitiveInclude( implementation( "io.ktor:ktor-serialization-kotlinx-json:2.3.11" )!! )

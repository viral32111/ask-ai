...
dependencies {
	...
	transitiveInclude( implementation( "io.ktor:ktor-client-serialization:3.0.3" )!! )
	transitiveInclude( implementation( "io.ktor:ktor-client-serialization-jvm:3.0.3" )!! )
	transitiveInclude( implementation( "io.ktor:ktor-client-content-negotiation:2.3.12" )!! )
	transitiveInclude( implementation( "io.ktor:ktor-serialization-kotlinx-json:2.3.12" )!! )
